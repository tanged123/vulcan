...
| `graph_jd_tt.html` | TAI seconds → JD TT conversion |
| `graph_centuries_tt.html` | Julian centuries since J2000.0 |
| `graph_visibility.html` | Full visibility objective |
| `graph_solar_elevation.html` | Solar elevation model |
